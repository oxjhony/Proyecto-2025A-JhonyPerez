...
class QNodesMod(SIA):
    ...
    def __init__(self, gestor: Manager):
        ...
        self.logger = SafeLogger(QNODESMOD_STRAREGY_TAG)
...
#-----------------------------------------------------------------------------------------
    ...
    def funcion_submodular(
        ...
        """
#------------------------------------------------------------------------------------------
        # Crear una clave única para memoización
        clave_memo = (tuple(deltas), tuple(map(tuple, omegas)))


        # Verificar si ya se calculó previamente
        if clave_memo in self.memoria_omega:
            return self.memoria_omega[clave_memo]
#-------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------
        ...
        self.memoria_omega[clave_memo] = (emd_union, emd_delta, vector_delta_marginal)
